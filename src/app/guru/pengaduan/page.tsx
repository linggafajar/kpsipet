  ...
  const fetchData = async () => {
    try {
      ...
      if (guruData.length > 0) {
        setFormData((prev) => ({
          ...prev,
          id_guru: guruData[0].id_guru.toString(),
        }));
      }
    } catch (error) {
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-2">
                Minimal 20 karakter. Sertakan informasi tanggal, waktu, dan
                kronologi kejadian.
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Catatan:</strong> Pengaduan yang Anda buat akan
                diteruskan ke Bimbingan Konseling (BK) untuk ditindaklanjuti.
